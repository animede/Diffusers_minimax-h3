...
2026-08-10 更新 / 2026-08-11 実測反映: 投影TE NF4(常駐3.11GB)とデコード位相の削減
...
| 16GB(~15.2) | 不可(TE 17.45 が載らない) | **実測済(2026-08-11)**: 実 RTX 4060 Ti 16GB **単体**で t2i/t2va/ref2i/i2va/音声参照/768×1344 全部完走(ピーク 7.4〜15.2GB)。従来「不可」だった16GBに道が開いた |
