...
### 1. diffusers PR #14355 — **merged on 2026-08-05. Migration not yet performed (impact investigated, 2026-08-09)**

PR #14355 was **merged at 2026-08-05 17:00Z** (merge commit `f53d552`, the PR's final head
was `f37ab93`). The venv remains **pinned to abc5e9b (2026-08-02)** (confirmable via
`pip`'s `direct_url.json`), and since abc5e9b is an ancestor of f37ab93, the SHA-pinned
reinstall procedure (in the setup section at the top) will continue to work going forward.
There is no stable release including H3 yet (the latest v0.39.0 is from 7/3; H3 arrives
starting with v0.40.0).
