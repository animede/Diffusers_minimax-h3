...
**現時点の最速は 96GB機での t2i 7.65s / t2va 5秒 28.56s**(2026-08-12 実測、全部盛り。
GPU0 に int8 transformer 常駐 + GPU1 に投影TE 常駐 + turbo + sage + fp16 デコード)。
ピークは **42.5GB** で、速さの源は容量ではなく固定費ゼロ運用のほう(詳細は日付節
2026-08-12)。
