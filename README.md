...
**672×384 → 1344×768・12steps がこの構成の実用解**: ピーク 44.43GB で 48GB 級に収まり、
1344×768 を直接生成する 49.7GB より軽く、96秒で出る。
...
| 1344×768 を得る方法 | ピーク | 48GB 級予算 ~49.8GB |
|---|---|---|
| t2va を直接 1344×768 で生成 | 49.7GB 級 | ほぼ余裕なし |
| **672×384 → upscale で 1344×768** | **44.67GB** | **余裕 ~5GB** |
